...
/* harmony import */ var _components_Waveform_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/Waveform.js */ "./src/js/components/Waveform.js");
...
class AudioVisualizer {
  ...
  constructor(options) {
    if (options.type === 'bars') {
      ...
      return new _components_Waveform_js__WEBPACK_IMPORTED_MODULE_6__["default"](options);
    }
...
class Timeline extends _utils_VisuComponentMono_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  constructor(options) {
    ...
    this._hotCues = [...options.hotCues] || false;
    this._beatsArray = [];
    this._beatCount = '0.0';
...
class Waveform extends _utils_VisuComponentMono_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
