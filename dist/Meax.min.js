...
/* harmony import */ var _core_SessionManager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core/SessionManager.js */ "./src/js/core/SessionManager.js");
...
/* harmony import */ var _core_UserInterface_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./core/UserInterface.js */ "./src/js/core/UserInterface.js");
/* harmony import */ var _utils_Kom_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/Kom.js */ "./src/js/utils/Kom.js");
/* harmony import */ var _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/Enums.js */ "./src/js/utils/Enums.js");
/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/Utils.js */ "./src/js/utils/Utils.js");
/* harmony import */ var _utils_CustomEvents_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/CustomEvents.js */ "./src/js/utils/CustomEvents.js");
...
window.CustomEvents = new _utils_CustomEvents_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
window.Utils = new _utils_Utils_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
window.Enums = _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"];
...
class Meax {
  ...
  init() {
    this._sm = new _core_SessionManager_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    ...
    this._ui = new _core_UserInterface_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._kom = new _utils_Kom_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
  }
  ...
  _onControllerEvent(element) {
    ...
    if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Components.MIXER) {
      this._mixerEvents(element, actionId);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Components.DECK_LEFT) {
      this._deckEvents('left', element, actionId);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Components.DECK_RIGHT) {
      this._deckEvents('right', element, actionId);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Components.PAD_LEFT) {
      this._padEvents('left', element, actionId, false);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Components.PAD_LEFT_SHIFT) {
      this._padEvents('left', element, actionId, true);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Components.PAD_RIGHT) {
      this._padEvents('right', element, actionId, false);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Components.PAD_RIGHT_SHIFT) {
  ...
  _mixerEvents(element, actionId) {
    if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.LEFT_LOAD_TRACK && element.value === 'push') {
    ...
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.RIGHT_LOAD_TRACK && element.value === 'push') {
    ...
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.SELECTION_ROTARY) {
      // Navigate on pl is a UI only action
      this._ui.navigateInPlaylist('left', element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.LEFT_FILTER) {
    ...
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.RIGHT_FILTER) {
    ...
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.CROSSFADER) {
  ...
  _deckEvents(side, element, actionId) {
    if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PLAY && element.value === 'push') {
      const playStatus = this._pc.togglePlayback(side, element);
      this._dh.sendMIDIMessage([element.raw[0], element.raw[1], playStatus]);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.CUE_PHONES_LEFT && element.value === 'push') {
      this._pc.setCuePhone(side, element);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PERFORMANCE_TAB_1) {
      this._pc.setPadType(side, element, 0);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PERFORMANCE_TAB_2) {
      this._pc.setPadType(side, element, 1);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PERFORMANCE_TAB_3) {
      this._pc.setPadType(side, element, 2);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PERFORMANCE_TAB_4) {
      this._pc.setPadType(side, element, 3);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PERFORMANCE_TAB_5) {
      this._pc.setPadType(side, element, 4);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PERFORMANCE_TAB_6) {
      this._pc.setPadType(side, element, 5);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PERFORMANCE_TAB_7) {
      this._pc.setPadType(side, element, 6);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PERFORMANCE_TAB_8) {
      this._pc.setPadType(side, element, 7);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.VOLUME) {
      this._pc.setVolume(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.VOLUME_TRIM) {
      this._pc.setTrimVolume(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.TEMPO) {
      this._pc.setTempo(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.JOGWHEEL_SLOW) {
      this._pc.adjustProgressSlow(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.JOGWHEEL_FAST) {
      this._pc.adjustProgressFast(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.HIGH_EQ) {
      this._pc.setHighEQ(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.MID_EQ) {
      this._pc.setMidEQ(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.LOW_EQ) {
  ...
  _padEvents(side, element, actionId, shift) {
    ...
    if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PAD_1) {
      this._pc.setPad(side, element, 1, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PAD_2) {
      this._pc.setPad(side, element, 2, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PAD_3) {
      this._pc.setPad(side, element, 3, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PAD_4) {
      this._pc.setPad(side, element, 4, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PAD_5) {
      this._pc.setPad(side, element, 5, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PAD_6) {
      this._pc.setPad(side, element, 6, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PAD_7) {
      this._pc.setPad(side, element, 7, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_5__["default"].Commands.PAD_8) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ui_Deck_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../ui/Deck.js */ "./src/js/ui/Deck.js");
/* harmony import */ var _ui_Mixer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../ui/Mixer.js */ "./src/js/ui/Mixer.js");
/* harmony import */ var _ui_Playlist_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../ui/Playlist.js */ "./src/js/ui/Playlist.js");
/* harmony import */ var _ui_component_ProgressRing_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../ui/component/ProgressRing.js */ "./src/js/ui/component/ProgressRing.js");
...
class UserInterface {
  ...
  constructor() {
    ...
    window.customElements.define('progress-ring', _ui_component_ProgressRing_js__WEBPACK_IMPORTED_MODULE_3__["default"]);

    this._leftDeck = new _ui_Deck_js__WEBPACK_IMPORTED_MODULE_0__["default"]('left');
    this._rightDeck = new _ui_Deck_js__WEBPACK_IMPORTED_MODULE_0__["default"]('right');
    this._mixer = new _ui_Mixer_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._playlist = new _ui_Playlist_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
...
/* harmony import */ var _component_Pad_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./component/Pad.js */ "./src/js/ui/component/Pad.js");
/* harmony import */ var _component_TimelineController_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./component/TimelineController.js */ "./src/js/ui/component/TimelineController.js");
/* harmony import */ var _component_WaveformController_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./component/WaveformController.js */ "./src/js/ui/component/WaveformController.js");
...
class Deck {
  ...
  constructor(name) {
    ...
    this._hotCues = [];
    this._timelineController = new _component_TimelineController_js__WEBPACK_IMPORTED_MODULE_2__["default"](this._name);
    this._waveformController = new _component_WaveformController_js__WEBPACK_IMPORTED_MODULE_3__["default"](this._name);

    this._performancePad = new _component_Pad_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
      name: this._name,
      type: 'hotcue'
    });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modal_EditCueModal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modal/EditCueModal.js */ "./src/js/ui/modal/EditCueModal.js");
...
class Pad {
  ...
  saveHotCue(options) {
    ...
    CustomEvents.addEvent('click', button, event => {
      ...
      const modal = new _modal_EditCueModal_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
        name: this._name,
...
/***/ "./src/js/ui/component/TimelineController.js":
/*!***************************************************!*\
  !*** ./src/js/ui/component/TimelineController.js ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modal_TimelineColorsModal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modal/TimelineColorsModal.js */ "./src/js/ui/modal/TimelineColorsModal.js");
...
class TimelineController {
  ...
  colorUpdateModal() {
    const modal = new _modal_TimelineColorsModal_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      name: this._name,
      colors: this._colors,
...
/* harmony default export */ __webpack_exports__["default"] = (TimelineController);


/***/ }),

/***/ "./src/js/ui/component/WaveformController.js":
/*!***************************************************!*\
  !*** ./src/js/ui/component/WaveformController.js ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modal_WaveformOptionsModal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modal/WaveformOptionsModal.js */ "./src/js/ui/modal/WaveformOptionsModal.js");
...
class WaveformController {
  ...
  optionsUpdateModal(event) {
    ...
    const modal = new _modal_WaveformOptionsModal_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      name: this._name,
      colors: this._colors,
      align: this._alignValue,
...
/* harmony default export */ __webpack_exports__["default"] = (WaveformController);


/***/ }),

/***/ "./src/js/ui/modal/EditCueModal.js":
/*!*****************************************!*\
  !*** ./src/js/ui/modal/EditCueModal.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ModalBase_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ModalBase.js */ "./src/js/ui/modal/ModalBase.js");



class EditCueModal extends _ModalBase_js__WEBPACK_IMPORTED_MODULE_0__["default"]  {
...
/* harmony default export */ __webpack_exports__["default"] = (EditCueModal);


/***/ }),

/***/ "./src/js/ui/modal/ModalBase.js":
/*!**************************************!*\
  !*** ./src/js/ui/modal/ModalBase.js ***!
  \**************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (ModalBase);


/***/ }),

/***/ "./src/js/ui/modal/TimelineColorsModal.js":
/*!************************************************!*\
  !*** ./src/js/ui/modal/TimelineColorsModal.js ***!
  \************************************************/
/*! exports provided: default */
...
class TimelineColorsModal extends _ModalBase_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony default export */ __webpack_exports__["default"] = (TimelineColorsModal);


/***/ }),

/***/ "./src/js/ui/modal/WaveformOptionsModal.js":
/*!*************************************************!*\
  !*** ./src/js/ui/modal/WaveformOptionsModal.js ***!
  \*************************************************/
/*! exports provided: default */
...
class WaveformOptionsModal extends _ModalBase_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/* harmony default export */ __webpack_exports__["default"] = (WaveformOptionsModal);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Enums_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Enums.js */ "./src/js/utils/Enums.js");
...
class Kom {
  ...
  _getErrorCodeFromHTTPStatus(code) {
    if (code === _Enums_js__WEBPACK_IMPORTED_MODULE_0__["default"].NOT_FOUND) {
      return 'B_KOM_NOT_FOUND';
    } else if (code === _Enums_js__WEBPACK_IMPORTED_MODULE_0__["default"].FORBIDDEN) {
      return 'B_KOM_ACCESS_FORBIDDEN';
    } else if (code === _Enums_js__WEBPACK_IMPORTED_MODULE_0__["default"].INTERNAL_ERROR) {
  ...
  _resolveAsRaw(response) {
    return new Promise((resolve, reject) => {
      if (response) {
        if (response.status === _Enums_js__WEBPACK_IMPORTED_MODULE_0__["default"].OK) {
