...
/* harmony import */ var _utils_Kom_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/Kom.js */ "./src/js/utils/Kom.js");
/* harmony import */ var _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/Enums.js */ "./src/js/utils/Enums.js");
/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/Utils.js */ "./src/js/utils/Utils.js");
/* harmony import */ var _utils_CustomEvents_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/CustomEvents.js */ "./src/js/utils/CustomEvents.js");
...
window.CustomEvents = new _utils_CustomEvents_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
window.Utils = new _utils_Utils_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
window.Enums = _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"];
...
class Meax {
  ...
  init() {
    ...
    this._kom = new _utils_Kom_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  }
  ...
  _onControllerEvent(element) {
    ...
    if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Components.MIXER) {
      this._mixerEvents(element, actionId);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Components.DECK_LEFT) {
      this._deckEvents('left', element, actionId);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Components.DECK_RIGHT) {
      this._deckEvents('right', element, actionId);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Components.PAD_LEFT) {
      this._padEvents('left', element, actionId, false);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Components.PAD_LEFT_SHIFT) {
      this._padEvents('left', element, actionId, true);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Components.PAD_RIGHT) {
      this._padEvents('right', element, actionId, false);
    } else if (componentId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Components.PAD_RIGHT_SHIFT) {
  ...
  _mixerEvents(element, actionId) {
    if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.LEFT_LOAD_TRACK && element.value === 'push') {
    ...
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.RIGHT_LOAD_TRACK && element.value === 'push') {
    ...
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.SELECTION_ROTARY) {
      // Navigate on pl is a UI only action
      this._ui.navigateInPlaylist('left', element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.LEFT_FILTER) {
    ...
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.RIGHT_FILTER) {
    ...
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.CROSSFADER) {
  ...
  _deckEvents(side, element, actionId) {
    if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PLAY && element.value === 'push') {
      const playStatus = this._pc.togglePlayback(side, element);
      this._dh.sendMIDIMessage([element.raw[0], element.raw[1], playStatus]);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.CUE_PHONES_LEFT && element.value === 'push') {
      this._pc.setCuePhone(side, element);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PERFORMANCE_TAB_1) {
      this._pc.setPadType(side, element, 0);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PERFORMANCE_TAB_2) {
      this._pc.setPadType(side, element, 1);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PERFORMANCE_TAB_3) {
      this._pc.setPadType(side, element, 2);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PERFORMANCE_TAB_4) {
      this._pc.setPadType(side, element, 3);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PERFORMANCE_TAB_5) {
      this._pc.setPadType(side, element, 4);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PERFORMANCE_TAB_6) {
      this._pc.setPadType(side, element, 5);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PERFORMANCE_TAB_7) {
      this._pc.setPadType(side, element, 6);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PERFORMANCE_TAB_8) {
      this._pc.setPadType(side, element, 7);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.VOLUME) {
      this._pc.setVolume(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.VOLUME_TRIM) {
      this._pc.setTrimVolume(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.TEMPO) {
      this._pc.setTempo(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.JOGWHEEL_SLOW) {
      this._pc.adjustProgressSlow(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.JOGWHEEL_FAST) {
      this._pc.adjustProgressFast(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.HIGH_EQ) {
      this._pc.setHighEQ(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.MID_EQ) {
      this._pc.setMidEQ(side, element.value);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.LOW_EQ) {
  ...
  _padEvents(side, element, actionId, shift) {
    ...
    if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PAD_1) {
      this._pc.setPad(side, element, 1, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PAD_2) {
      this._pc.setPad(side, element, 2, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PAD_3) {
      this._pc.setPad(side, element, 3, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PAD_4) {
      this._pc.setPad(side, element, 4, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PAD_5) {
      this._pc.setPad(side, element, 5, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PAD_6) {
      this._pc.setPad(side, element, 6, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PAD_7) {
      this._pc.setPad(side, element, 7, shift);
    } else if (actionId === _utils_Enums_js__WEBPACK_IMPORTED_MODULE_4__["default"].Commands.PAD_8) {
...
class Pad {
      ...
      if (this._activeMode === 0) { // HotCue
        if (this._hotCues[index] === -1) { // Save the cue point
          ...
          CustomEvents.publish('Pad/SaveHotCue', {
            ...
            active: value.raw[2] === 127 ? true : false,
            time: time,
            color: _utils_Enums_js__WEBPACK_IMPORTED_MODULE_0__["default"].DefaultColors.hotCue
          });
  ...
  setPadType(deckSide, value, padNumber) {
    ...
    this._type = _utils_Enums_js__WEBPACK_IMPORTED_MODULE_0__["default"].PerformanceType[padNumber + 1];
...
/* harmony import */ var _utils_Enums_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/Enums.js */ "./src/js/utils/Enums.js");
...
class TimelineController {
  ...
  setHotCue(options) {
    return this._timeline.setHotCuePoint({
      color: _utils_Enums_js__WEBPACK_IMPORTED_MODULE_1__["default"].DefaultColors.hotCue,
      label: options.pad
    });
  }
